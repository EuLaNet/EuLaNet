...
A model-independent physical data representation that augments conventional Eulerian CFD fields with sparse Lagrangian material evolution, finite-time deformation, and explicit same-time Eulerian–Lagrangian correspondence.

EuLaNet turns raw CFD solutions into a structured dataset for downstream **machine learning, reinforcement learning, and DeepRL** experiments without prescribing a particular learning architecture.
...
- [2. What happens to a CFD .vtu file?](#2-what-happens-to-a-cfd-vtu-file)
- [3. Eulerian variables](#3-eulerian-variables)
- [4. Constructing the Lagrangian representation](#4-constructing-the-lagrangian-representation)
- [5. Material advection](#5-material-advection)
- [6. RK4 integration](#6-rk4-integration)
- [7. The flow map](#7-the-flow-map)
- [8. Particle displacement](#8-particle-displacement)
- [9. Deformation gradient](#9-deformation-gradient)
- [10. Cauchy–Green deformation tensor](#10-cauchygreen-deformation-tensor)
- [11. Eigenvalue decomposition](#11-eigenvalue-decomposition)
- [12. FTLE](#12-ftle)
- [13. Validity is preserved](#13-validity-is-preserved)
- [14. The Lagrangian feature vector](#14-the-lagrangian-feature-vector)
- [15. Why correspondence is necessary](#15-why-correspondence-is-necessary)
- [16. Same-time Eulerian–Lagrangian correspondence](#16-same-time-eulerianlagrangian-correspondence)
- [17. Why the same-time mapping matters](#17-why-the-same-time-mapping-matters)
- [18. Correspondence fields](#18-correspondence-fields)
- [19. The final representation](#19-the-final-representation)
- [20. What this gives a learning system](#20-what-this-gives-a-learning-system)
- [21. Why this was built](#21-why-this-was-built)
- [22. Model independence](#22-model-independence)
- [23. Dataset structure](#23-dataset-structure)
- [24. Validated reference case](#24-validated-reference-case)
- [25. Usage](#25-usage)
- [26. In one equation](#26-in-one-equation)
...
FTLE=2∣t−t0​∣1​logλmax​(C)​ 

or equivalently,

FTLE=∣t−t0​∣1​logλmax​(C)​. 
...
correspondence\_snapshot=snapshot\_id​ 
